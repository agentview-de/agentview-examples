# Smart Home Wall Dashboard (Light)

A fullscreen wall-tablet display for smart homes, featuring a bright aesthetic. It combines time, weather, calendar, energy, room climate, device status, security, and household tasks in one glanceable view.
